...
public class CategoriesAdapter extends RecyclerView.Adapter<CatsVH> {

    private Context context;
    private LayoutInflater inflater;
    private List<Categories> data;
    private List<TemplatesModel> dataTempList;
    private CatsVH usersViewHolder;
    private Categories current;
    private ImageLoader imageLoader;
    private ArrayList<SubCatsModel> subCatsModelArrayList;


    public CategoriesAdapter(Context context, List<Categories> data, List<TemplatesModel> dataTempList) {
    ...
    @NonNull
    @Override
    public CatsVH onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.item_cats, viewGroup, false);


        usersViewHolder = new CatsVH(view);

        return usersViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final CatsVH usersViewHolder, final int i) {
        ...
        TempaltesAdapter categoriesAdapter = new TempaltesAdapter(context, temp);
