...
import com.ashu.postermaker.adapters.CategoriesAdapter2;
...
public class SliderMainActivityTwo extends AppCompatActivity {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < JA.length(); i++) {
                                ...
                                categoriesAdapter = new CategoriesAdapter2(context, categoriesArrayList, templatesModelArrayList);
...
//            }
    ...
    private void getDisscusion() {
//        LoadingDialog.startAnim(avi);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://karimapps.com/soka/api/get_all_threads_discussions.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        String result = response.toString();
                        ...
                        try {
                            ...
                            for (int i = 0; i < JA.length(); i++) {
                                JSONObject object1 = JA.getJSONObject(i);
                                String description = object1.getString("body");
                                String description1 = object1.getString("body");
                                String description2 = object1.getString("body");
                                i++;
                                JSONObject object11 = JA.getJSONObject(i);

                                String username = object11.getString("username");
                                String username2 = object11.getString("username");
